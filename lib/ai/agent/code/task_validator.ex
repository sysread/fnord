defmodule AI.Agent.Code.TaskValidator do
  ...
  - You can use the `cmd_tool` to run commands that are not covered directly by the tool_calls you have access to.
  - You can also use the `cmd_tool` to test the behavior of the code in a more interactive way, such as evaluating commands with interpreted languages or running scripts.
