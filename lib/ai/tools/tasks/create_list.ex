    ...
    %{
      ...
      function: %{
        ...
        description: """
          ...
          Task lists are intended to help you retain state between interactions,
          even if your context window is full.
          You can add new tasks to the end of the list, push tasks to the front of
          the list (treating it as a stack), and mark tasks as completed or failed.
          You can also fetch the entire list of tasks, including their status and
          results.
        """,
        parameters: %{
          type: "object",
