defmodule GitCli.Worktree.Review.Default do
  @moduledoc """
  Real implementation of the `GitCli.Worktree.Review` behaviour. See
  `GitCli.Worktree.Review` for the public contract and per-function
  documentation.

  Worktree operations go through the `GitCli.Worktree` facade so a test
  double on the `:git_worktree` Globals key intercepts them.
  """

  @behaviour GitCli.Worktree.Review

  alias GitCli.Worktree.Review
